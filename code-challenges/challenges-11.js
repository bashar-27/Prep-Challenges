...
function fullName(arr) {
    let fullName = arr.map(function(element){
...
function gradesAvg(arr) {
    ...
    let avgArr = arr.map(arr=> {
        let sumGrade=arr.gradsList.reduce((totalGrade,grade)=>totalGrade+grade,0);
        let avg= sumGrade/arr.gradsList.length;
            return {...arr,avg}; 
